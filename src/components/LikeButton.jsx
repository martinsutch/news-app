...
const LikeButton = ({ likes, setLikes, article_id }) => {
  ...
  const handleLike = () => {
    ...
    if (liked) {
      ...
      setStatus({
        icon: "loading",
        msg: "You're liking this article!",
        colour: "green",
        duration: 0,
      });
      patchArticleById(article_id, { inc_votes: 1 })
  ...
  return (
    ...
    >
      <img
        className="icon"
        src={`/assets/like-${liked ? "fill" : "outline"}.svg`}
      />
      <span>
